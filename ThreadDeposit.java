...
class GFG {
    ...
    public static void main(String[] args)
    {
        ...
        // Creating threads
        ThreadWithdrawal t1 = new ThreadWithdrawal(obj, "Uzair", 1000);

        ThreadWithdrawal t2 = new ThreadWithdrawal(obj, "Abdul Basit", 1500);

        ThreadDeposit t3 = new ThreadDeposit(obj, "Sohail", 500);

        ThreadWithdrawal t4 = new ThreadWithdrawal(obj, "Razzak", 2000);

        ThreadWithdrawal t5 = new ThreadWithdrawal(obj, "Muzamil", 3500);
